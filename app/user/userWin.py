...
class UserWin(QWidget):
    def init_user_ui(self):
        ...
        #self.results_btn.clicked.connect(partial(button_animation, btn=self.results_btn, win=self, f=partial(, type='игру')))
        ...
        self.results_btn.setGraphicsEffect(QGraphicsDropShadowEffect(blurRadius=5, xOffset=4, yOffset=4, color=QColor(0, 0, 0)))
